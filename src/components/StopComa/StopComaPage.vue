      ...
      <el-row :gutter="10">
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          ...
          <ul class="warning-bullet">
            ...
            <li>
              Ребенок жалуется на раздражение в области половых органов, в особенности после мочеиспускания
            </li>
      ...
      <el-row :gutter="10">
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          ...
          <ul class="primary-bullet">
            <li>
              Обратитесь к врачу сегодня же, если симптомы схожи! Промедление опасно для жизни ребенка!
            </li>
          </ul>
        ...
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
          ...
          <ul class="primary-bullet">
            <li>
              Известите родителей и спросить у них разрешение проверить уровень сахара (глюкозы) в крови из
              пальца Вызовите медсестру, попросите проверить с помощью глюкометра уровень глюкозы в крови
            </li>
            <li>
              Передайте ребенка на руки родителям и выдайте им памятку с телефонами дежурного эндокринолога
            </li>
