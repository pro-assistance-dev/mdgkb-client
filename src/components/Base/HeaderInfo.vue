  ...
  <div class="mainblock">
    ...
    >
      <div class="mainblock-right1">
        ...
        <div class="mainblock-right1-item3">
          <slot name="tags" />
        </div>
        <div class="mainblock-right1-item4">
          <slot name="contact" />
        </div>
        <div class="mainblock-right1-item5">
          <slot name="icons" />
        </div>
      </div>
...
.mainblock-right1-item4 {
  max-width: 687px;
  min-height: 40px;
  // border-bottom: 1px solid #e9e9e9;
}

.mainblock-right1-item5 {
  position: absolute;
  bottom: 0px;
  left: 0px;
  display: flex;
