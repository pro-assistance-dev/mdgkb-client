<template>
  ...
  <svg width="0" height="0" class="hidden">
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" id="time">
      <path d="M9.99 0C4.47 0 0 4.48 0 10C0 15.52 4.47 20 9.99 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 9.99 0ZM10 18.5C5.58 18.5 1.5 14.42 1.5 10C1.5 5.58 5.57 1.5 9.99 1.5C14.41 1.5 18.5 5.58 18.5 10C18.5 14.42 14.42 18.5 10 18.5ZM9.78 5H9.72C9.32 5 9 5.32 9 5.72V10.44C9 10.79 9.18 11.12 9.49 11.3L13.64 13.79C13.98 13.99 14.42 13.89 14.62 13.55C14.6702 13.469 14.7036 13.3788 14.7182 13.2846C14.7328 13.1905 14.7283 13.0943 14.705 13.002C14.6817 12.9096 14.64 12.8229 14.5824 12.7469C14.5249 12.671 14.4526 12.6074 14.37 12.56L10.5 10.26V5.72C10.5 5.32 10.18 5 9.78 5Z"></path>
    </symbol>
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 20" id="map-marker">
      <path d="M8 12C10.206 12 12 10.206 12 8C12 5.794 10.206 4 8 4C5.794 4 4 5.794 4 8C4 10.206 5.794 12 8 12ZM8 5.5C9.5 5.5 10.5 6.5 10.5 8C10.5 9.5 9.5 10.5 8 10.5C6.5 10.5 5.5 9.5 5.5 8C5.5 6.5 6.5 5.5 8 5.5Z"></path>
      <path d="M7.42 17.8142C7.58925 17.935 7.79203 18 8 18C8.20797 18 8.41075 17.935 8.58 17.8142C8.884 17.5992 15.5 14 15.5002 8C15.5002 4 12 0.5 8.00019 0.5C4.00038 0.5 0.500095 4 0.500095 8C0.5 14 7 17.5 7.42 17.8142ZM8.00028 2C11.3093 2 14.0003 4.691 14.0003 8.005C14.0003 12.6879 10 15 8.00019 16.5C6 15 1.97928 12.441 2.00028 8C2.00028 4.691 4.69128 2 8.00028 2Z"></path>
    </symbol>

    <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4 4" id="point">
