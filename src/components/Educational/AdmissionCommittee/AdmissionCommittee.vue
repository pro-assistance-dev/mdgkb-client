  ...
  <PageComponent :custom-sections="customSections">
    ...
    <template #bottom>
      <div class="button-container">
        <PButton text="Подать документы" type="success" style="margin: 10px 0" height="60px" @click="toForm()" />
      </div>
    </template>
    <template #title>
      <div class="title-button-container">
        <PButton type="success" text="Подать документы" style="margin: 10px 0" height="60px" width="160px" @click="toForm()" />
      </div>
    </template>
  </PageComponent>
</template>
