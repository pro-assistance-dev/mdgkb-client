                  ...
                  <el-table-column width="50" fixed="right" align="center">
                    <template #default="scope">
                      <TableButtonGroup
                        ...
                        @remove="
                          $classHelper.RemoveFromClassByIndex(scope.$index, dpoCourse.dpoCoursesDates, dpoCourse.dpoCoursesDatesForDelete)
                        "
                      />
                    </template>
                  </el-table-column>
                      ...
                      <TableButtonGroup
                        ...
                        @remove="
                          $classHelper.RemoveFromClassByIndex(
                            scope.$index,
                            dpoCourse.dpoCoursesTeachers,
                            dpoCourse.dpoCoursesTeachersForDelete
                          )
                        "
                      />
                    </template>
