  ...
  <el-card>
    <template #header>
      <div class="flex-between">
        ...
        <PButton skin="text" type="success" text="+ Добавить группу правил" margin="0" @click="division.addVisitingRuleGroup()" />
      </div>
    </template>
        ...
        <el-table-column label="Правила посещения" sortable>
          <template #default="scope">
            <el-form-item style="margin: 0">
              <el-input v-model="scope.row.text" placeholder="Правило" type="textarea" />
            </el-form-item>
          </template>
        </el-table-column>
        <el-table-column label="Тип" width="200" align="center">
          <template #default="scope">
            <el-switch v-model="scope.row.isListItem" active-text="Список" inactive-text="Текст" />
          </template>
        </el-table-column>
        <el-table-column width="50" align="center">
          <template #default="scope">
